...
var item_props = {
	...
	hpspeed: {lbl: 'Скорость восстановления жизни', fmt: '{0}%', view: false, inmfg: true},
	manaspeed: {lbl: 'Скорость восстановления маны', fmt: '{0}%', view: false, inmfg: true},
...
//	edefence: {lbl: 'Защита от колющего, рубящего, дробящего и режущего урона', maxvalue: 1000, view: false, nocharm: true},
	...
	greymagicpower: {lbl: 'Мф. мощности Серой магии', fmt: '{0}%', view: false, inmfg: true},
