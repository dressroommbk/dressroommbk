...
//	edefence: {lbl: 'Защита от колющего, рубящего, дробящего и режущего урона', maxvalue: 1000, view: false, nocharm: true},
	...
	magicdefencereduce: {lbl: 'Подавление защиты от магии', fmt: '{0}%', maxvalue: 99, view: true, inmfg: true, nocharm: true},
	firemagicdefencereduce: {lbl: 'Подавление защиты от магии Огня', fmt: '{0}%', maxvalue: 99, view: true, inmfg: true, nocharm: true},
	airmagicdefencereduce: {lbl: 'Подавление защиты от магии Воздуха', fmt: '{0}%', maxvalue: 99, view: true, inmfg: true, nocharm: true},
	watermagicdefencereduce: {lbl: 'Подавление защиты от магии Воды', fmt: '{0}%', maxvalue: 99, view: true, inmfg: true, nocharm: true},
	earthmagicdefencereduce: {lbl: 'Подавление защиты от магии Земли', fmt: '{0}%', maxvalue: 99, view: true, inmfg: true, nocharm: true},
