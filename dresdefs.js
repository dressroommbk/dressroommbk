...
var localizer =
{
	...
	saveSet: 'Сохранить комплект',
	loadSet: 'Загрузить комплект',
...
var item_props = {
	...
	stats:{lbl: 'Количество увеличений', view: true, nocharm: true},
	...
	knifeskill: {lbl: 'Владение ножами и кинжалами', required: true, view: true, inmfg: true, inprpg: true, nocharm: true},
	axeskill: {lbl: 'Владение топорами и секирами', required: true, view: true, inmfg: true, inprpg: true, nocharm: true},
	clubskill: {lbl: 'Владение молотами и дубинами', required: true, view: true, inmfg: true, inprpg: true, nocharm: true},
	swordskill: {lbl: 'Владение мечами', required: true, view: true, inmfg: true, inprpg: true, nocharm: true},
	staffskill: {lbl: 'Владение посохами', required: true, view: true, inmfg: true, inprpg: true, nocharm: true},
	magicskill: {lbl: 'Владение магией Стихий', view: false, inmfg: true, nocharm: true},
	firemagicskill: {lbl: 'Владение магией Огня', required: true, view: true, inmfg: true, nocharm: true},
	airmagicskill: {lbl: 'Владение магией Воздуха', required: true, view: true, inmfg: true, nocharm: true},
	watermagicskill: {lbl: 'Владение магией Воды', required: true, view: true, inmfg: true, nocharm: true},
	earthmagicskill: {lbl: 'Владение магией Земли', required: true, view: true, inmfg: true, nocharm: true},
	lightmagicskill: {lbl: 'Владение магией Света', required: true, view: true, inmfg: true, nocharm: true},
	darkmagicskill: {lbl: 'Владение магией Тьмы', required: true, view: true, inmfg: true, nocharm: true},
	greymagicskill: {lbl: 'Владение серой магией', required: true, view: true, inmfg: true, nocharm: true},
	mindamage: {lbl: 'Минимальный урон', view: true, inmfg: true, inprpg: true, nocharm: true},
	maxdamage: {lbl: 'Максимальный урон', view: true, inmfg: true, inprpg: true, nocharm: true},
	...
	hpspeed: {lbl: 'Скорость восстановления жизни', fmt: '{0}%', view: false, inmfg: true, nocharm: true},
	manaspeed: {lbl: 'Скорость восстановления маны', fmt: '{0}%', view: false, inmfg: true, nocharm: true},
	manaconsumption: {lbl: 'Уменьшение расхода маны', fmt: '{0}%', maxvalue: 99, view: true, inmfg: true, nocharm: true},
	criticalpower: {lbl: 'Мф. мощности критического удара', fmt: '{0}%', view: true, inmfg: true, inprpg: true},
	absolutecriticalhit: {lbl: 'Абс. мф. крита', view: true, inmfg: true, inprpg: true, nocharm: true},
	...
	anticriticalpower: {lbl: 'Мф. против мощ. крит. удара', fmt: '{0}%', view: true, inmfg: true, nocharm: true},
	absolutejumpaway: {lbl: 'Абс. мф. уворота', view: true, inmfg: true, inprpg: true, nocharm: true},
	...
	thrustpower: {lbl: 'Мф. мощности колющего урона', fmt: '{0}%', view: true, inmfg: true, inprpg: true, nocharm: true},
	sabrepower: {lbl: 'Мф. мощности рубящего урона', fmt: '{0}%', view: true, inmfg: true, inprpg: true, nocharm: true},
	crushpower: {lbl: 'Мф. мощности дробящего урона', fmt: '{0}%', view: true, inmfg: true, inprpg: true, nocharm: true},
	cutpower: {lbl: 'Мф. мощности режущего урона', fmt: '{0}%', view: true, inmfg: true, inprpg: true, nocharm: true},
...
//	edefence: {lbl: 'Защита от колющего, рубящего, дробящего и режущего урона', maxvalue: 1000, view: false, nocharm: true},
	thrustdefence: {lbl: 'Защита от колющего урона', maxvalue: 1600, view: true, inmfg: true, inprpg: true, nocharm: true},
	sabredefence: {lbl: 'Защита от рубящего урона', maxvalue: 1600, view: true, inmfg: true, inprpg: true, nocharm: true},
	crushdefence: {lbl: 'Защита от дробящего урона', maxvalue: 1600, view: true, inmfg: true, inprpg: true, nocharm: true},
	cutdefence: {lbl: 'Защита от режущего урона', maxvalue: 1600, view: true, inmfg: true, inprpg: true, nocharm: true},
	magicdefence: {lbl: 'Защита от магии', maxvalue: 1600, view: true, inmfg: true},
	emagicdefence: {lbl: 'Защита от магии Стихий', maxvalue: 1600, view: false, nocharm: true, nocharm: true},
	firemagicdefence: {lbl: 'Защита от магии Огня', maxvalue: 1600, view: true, inmfg: true, nocharm: true},
	airmagicdefence: {lbl: 'Защита от магии Воздуха', maxvalue: 1600, view: true, inmfg: true, nocharm: true},
	watermagicdefence: {lbl: 'Защита от магии Воды', maxvalue: 1600, view: true, inmfg: true, nocharm: true},
	earthmagicdefence: {lbl: 'Защита от магии Земли', maxvalue: 1600, view: true, inmfg: true, nocharm: true},
	lightmagicdefence: {lbl: 'Защита от магии Света', maxvalue: 1600, view: true, inmfg: true, nocharm: true},
	darkmagicdefence: {lbl: 'Защита от магии Тьмы', maxvalue: 1600, view: true, inmfg: true, nocharm: true},
	greymagicdefence: {lbl: 'Защита от серой магии', maxvalue: 1600, view: false, inmfg: true, nocharm: true},
	magicpower: {lbl: 'Мф. мощности магии стихий', fmt: '{0}%', view: true, inmfg: true},
	magiccommonpower: {lbl: 'Мф. мощности магии', fmt: '{0}%', view: false, inmfg: true, nocharm: true},
	firemagicpower: {lbl: 'Мф. мощности магии Огня', fmt: '{0}%', view: true, inmfg: true, nocharm: true},
	airmagicpower: {lbl: 'Мф. мощности магии Воздуха', fmt: '{0}%', view: true, inmfg: true, nocharm: true},
	watermagicpower: {lbl: 'Мф. мощности магии Воды', fmt: '{0}%', view: true, inmfg: true, nocharm: true},
	earthmagicpower: {lbl: 'Мф. мощности магии Земли', fmt: '{0}%', view: true, inmfg: true, nocharm: true},
	lightmagicpower: {lbl: 'Мф. мощности магии Света', fmt: '{0}%', view: true, inmfg: true, nocharm: true},
	darkmagicpower: {lbl: 'Мф. мощности магии Тьмы', fmt: '{0}%', view: true, inmfg: true, nocharm: true},
	greymagicpower: {lbl: 'Мф. мощности Серой магии', fmt: '{0}%', view: false, inmfg: true, nocharm: true},
	magicdefencereduce: {lbl: 'Подавление защиты от магии', fmt: '{0}%', maxvalue: 1000, view: true, inmfg: true, nocharm: true},
	firemagicdefencereduce: {lbl: 'Подавление защиты от магии Огня', fmt: '{0}%', maxvalue: 1000, view: true, inmfg: true, nocharm: true},
	airmagicdefencereduce: {lbl: 'Подавление защиты от магии Воздуха', fmt: '{0}%', maxvalue: 1000, view: true, inmfg: true, nocharm: true},
	watermagicdefencereduce: {lbl: 'Подавление защиты от магии Воды', fmt: '{0}%', maxvalue: 1000, view: true, inmfg: true, nocharm: true},
	earthmagicdefencereduce: {lbl: 'Подавление защиты от магии Земли', fmt: '{0}%', maxvalue: 1000, view: true, inmfg: true, nocharm: true},
...
var knownECRPowerUps = {
	...
	spell_godprotect: {places: new Array(), id: 'spell_godprotect', caption: 'Неуязвимость Стихиям', modify: 'magicdefence', v: 300, legend: '<b>Неуязвимость Стихиям</b> (заклятие)<br />Защита от магии: +300'},
