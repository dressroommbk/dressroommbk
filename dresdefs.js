...
var item_props = {
	...
	defence: {lbl: 'Защита от урона', maxvalue: 1200, view: true, inmfg: true, inprpg: true},
	edefence: {lbl: 'Защита от колющего, рубящего, дробящего и режущего урона', maxvalue: 1000, view: true, nocharm: true},
	thrustdefence: {lbl: 'Защита от колющего урона', maxvalue: 1200, view: true, inmfg: true, inprpg: true},
	sabredefence: {lbl: 'Защита от рубящего урона', maxvalue: 1200, view: true, inmfg: true, inprpg: true},
	crushdefence: {lbl: 'Защита от дробящего урона', maxvalue: 1200, view: true, inmfg: true, inprpg: true},
	cutdefence: {lbl: 'Защита от режущего урона', maxvalue: 1200, view: true, inmfg: true, inprpg: true},
