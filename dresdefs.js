var baseImgPath = '/dressroommbk/images/';
var itemImgPath = '/dressroommbk/images/';
var hereItemImgPath = '/dressroommbk/images/';
var charImgPath = '/dressroommbk/images/';
var clanImgPath = '/dressroommbk/images/';
var zodiacImgPath = '/dressroommbk/images/';
var brandImgPath = '/dressroommbk/images/';
var brand2ImgPath = '/dressroommbk/images/';
var trickResourceImgPath = '/dressroommbk/images/';
var hpMeterGreenImg = '/dressroommbk/images/bk_life_green.gif';
var manaMeterImg = '/dressroommbk/images/bk_life_beg_33.gif';
var trickImgPath = '/dressroommbk/images/';
var iconImgPath = '/dressroommbk/images/icon_';
var infospaceImgPath = '/dressroommbk/images/';
var dressImgPath = '/dressroommbk/images/';
var blankImgPath = '/dressroommbk/images/blank.gif';
var toothImgPath = '/dressroommbk/images/';
...
//	attackqseldom: 'редки',                         //
	...
	badSkillCount: 'На [{0}] уровне {1} Вам доступно <b>{2}</b> родных владений, а в Вашем комплекте используется <font color="red"><b>{3}</b></font> родных владений. Пожалуйста, проверьте Ваши родные владения.',
...
var common_props = {
	emprice: {lbl: 'Цена (емр.)', fmt: '<font color="purple">{0}&nbsp;емр.</font>', view: true},
...
var item_props = {
	...
	totalemprice: {lbl: 'Стоимость предметов (емр.)', fmt: '{0}&nbsp;емр.', view: true, nocharm: true},
	...
	defence: {lbl: 'Защита от урона', maxvalue: 1000, view: true, inmfg: true, inprpg: true},
	edefence: {lbl: 'Защита от колющего, рубящего, дробящего и режущего урона', maxvalue: 1000, view: true, nocharm: true},
	thrustdefence: {lbl: 'Защита от колющего урона', maxvalue: 1000, view: true, inmfg: true, inprpg: true},
	sabredefence: {lbl: 'Защита от рубящего урона', maxvalue: 1000, view: true, inmfg: true, inprpg: true},
	crushdefence: {lbl: 'Защита от дробящего урона', maxvalue: 1000, view: true, inmfg: true, inprpg: true},
	cutdefence: {lbl: 'Защита от режущего урона', maxvalue: 1000, view: true, inmfg: true, inprpg: true},
	magicdefence: {lbl: 'Защита от магии', maxvalue: 1800, view: true, inmfg: true},
	emagicdefence: {lbl: 'Защита от магии Огня, Воздуха, Воды и Земли', maxvalue: 800, view: true, nocharm: true},
	firemagicdefence: {lbl: 'Защита от магии Огня', maxvalue: 800, view: true, inmfg: true},
	airmagicdefence: {lbl: 'Защита от магии Воздуха', maxvalue: 800, view: true, inmfg: true},
	watermagicdefence: {lbl: 'Защита от магии Воды', maxvalue: 800, view: true, inmfg: true},
	earthmagicdefence: {lbl: 'Защита от магии Земли', maxvalue: 800, view: true, inmfg: true},
	lightmagicdefence: {lbl: 'Защита от магии Света', maxvalue: 800, view: true, inmfg: true},
	darkmagicdefence: {lbl: 'Защита от магии Тьмы', maxvalue: 800, view: true, inmfg: true},
	greymagicdefence: {lbl: 'Защита от серой магии', maxvalue: 800, view: true, inmfg: true},
	...
	magicdefencereduce: {lbl: 'Понижение защиты от магии', fmt: '{0}%', maxvalue: 99, view: true, inmfg: true},
	firemagicdefencereduce: {lbl: 'Понижение защиты от магии Огня', fmt: '{0}%', maxvalue: 99, view: true, inmfg: true},
	airmagicdefencereduce: {lbl: 'Понижение защиты от магии Воздуха', fmt: '{0}%', maxvalue: 99, view: true, inmfg: true},
	watermagicdefencereduce: {lbl: 'Понижение защиты от магии Воды', fmt: '{0}%', maxvalue: 99, view: true, inmfg: true},
	earthmagicdefencereduce: {lbl: 'Понижение защиты от магии Земли', fmt: '{0}%', maxvalue: 99, view: true, inmfg: true},
	lightmagicdefencereduce: {lbl: 'Понижение защиты от магии Света', fmt: '{0}%', maxvalue: 99, view: true, inmfg: true},
	darkmagicdefencereduce: {lbl: 'Понижение защиты от магии Тьмы', fmt: '{0}%', maxvalue: 99, view: true, inmfg: true},
	greymagicdefencereduce: {lbl: 'Понижение защиты от серой магии', fmt: '{0}%', maxvalue: 99, view: true, inmfg: true},
