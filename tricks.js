var tricks = {
	...
	wis_air_mark: {name: 'wis_air_mark', caption: 'Цель Воздуха', description: 'Уменьшает сопротивляемость воздействию Магии Воздуха. Можно применить на одну цель до 5 раз.', school: 'air',
		required: {level:7,intellect:40,airmagicskill:7},
		resources: {},
		consumes: {mana:20,spiritlevel:0.5}
	},
	wis_air_sign: {name: 'wis_air_sign', caption: 'Знак Воздуха', description: 'Маг получает 10 маны каждый ход. Стоимость всех заклинаний снижена на 3%', school: 'air',
	...
	wis_air_charge: {name: 'wis_air_charge', caption: 'Статика', description: 'Молния, Цепь молний, Искра, Искры, и удары по Воздушному Щиту будут заряжать цель, увеличивая получаемый от магии Воздуха урон на 1%. Маг может воспользоваться накопленными зарядами.', school: 'air',
		required: {level:7,intellect:40,airmagicskill:7},
		consumes: {mana:25,spiritlevel:1}
	},
	wis_air_charge_shock: {name: 'wis_air_charge_shock', caption: 'Заряд: Шок', description: 'Шокирует противника, лишая его возможности использовать последний примененный прием на 5 ходов и рассеивает один позитивный магический эффект.', school: 'air',
		required: {level:7,intellect:40,airmagicskill:7},
		resources: {hp:1}
	},
	wis_air_charge_gain: {name: 'wis_air_charge_gain', caption: 'Заряд: Собрать', description: 'Восстанавливает 33 маны за каждый уровень Заряда на цели и снимает с мага один негативный магический эффект.', school: 'air',
		required: {level:7,intellect:40,airmagicskill:7},
		resources: {hp:1}
	},
	wis_air_charge_dmg: {name: 'wis_air_charge_dmg', caption: 'Заряд: Поражение', description: 'Наносит цели 1-2% урона магией Воздуха от ее максимального уровня жизни за каждый уровень Заряда. <br>Заклинание не может нанести более 350 ед. урона.<br>Заклинание не может нанести более 250 ед. урона для 9го уровня.<br>Заклинание не может нанести более 300 ед. урона для 10го уровня.<br>Заклинание не может нанести более 350 ед. урона для 11го уровня.', iname: 'wis_air_charge_dmg', school: 'air',
		required: {level:7,intellect:40,airmagicskill:7},
		resources: {hp:1}
	},
	wis_air_manaheal: {name: 'wis_air_manaheal', caption: 'Энергия Воздуха', description: 'Восстанавливает цели 1-10% маны за каждый ход работы заклинания. Заклинание прекращает действие при использовании любого другого заклинания через 5 ходов.', school: 'air',
		required: {level:7,intellect:40,airmagicskill:11},
		resources: {hp:1},
		consumes: {spiritlevel:3}
	},
	wis_air_sacrifice: {name: 'wis_air_sacrifice', caption: 'Жертва Воздуху', description: 'Маг получает 25 мф. мощности магии Воздуха на 4 хода. Снимается приемом Очистится кровью.', school: 'air',
		required: {level:7,intellect:40,airmagicskill:7},
		resources: {hp:5},
		consumes: {mana:10}
	},
	wis_air_speed: {name: 'wis_air_speed', caption: 'Скорость Молнии', description: 'Начальная задержка: 5. Любой следующий прием не тратит хода.', school: 'air',
		required: {level:8,intellect:50,airmagicskill:8},
		consumes: {mana:85,spiritlevel:4}
	},
	wis_air_spark: {name: 'wis_air_spark', caption: 'Искра', description: 'Мгновенно наносит враждебной цели урон воздухом или исцеляет дружественную.', school: 'air',
		required: {level:8,intellect:50,airmagicskill:8},
		consumes: {mana:121}
	},
